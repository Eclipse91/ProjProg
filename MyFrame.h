...
public:
    ...
    wxString ListTitle[4];
    wxString ListCardTitle[20];
    wxString ListHighPriority[20];
    wxString ListDeadLine[20];
    int NumberMembers[20];
    wxString ListMemberLine[60];
    int NumberSublist[20];
    wxString ListSublistLine[240];
